...
const formValidation = (pokemon) => {
  ...
  if (!imageRegex.test(pokemon.image) || !imageRegexURL.test(pokemon.image))
    errors.image = "Sólo URL por el momento.";
  if (pokemon.image === "") errors.image = "Campo obligatorio.";
  if (pokemon.life <= 0 || isNaN(parseFloat(pokemon.life)))
    errors.life = "Campo obligatorio.";
  if (pokemon.life > 999) errors.life = "Digite un valor menor a 999.";

  if (pokemon.attack <= 0 || isNaN(parseFloat(pokemon.attack)))
    errors.attack = "Campo obligatorio.";
  if (pokemon.attack > 999) errors.life = "Digite un valor menor a 999.";

  if (pokemon.defense <= 0 || isNaN(parseFloat(pokemon.defense)))
    errors.defense = "Campo obligatorio.";
  if (pokemon.defense > 999) errors.life = "Digite un valor menor a 999.";
  ...
  if (pokemon.speed > 999) errors.life = "Digite un valor menor a 999.";
  if (pokemon.weight > 999) errors.life = "Digite un valor menor a 999.";
  if (pokemon.weight > 999) errors.life = "Digite un valor menor a 999";
